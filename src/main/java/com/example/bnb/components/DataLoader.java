...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Property property1 = new Property(jarrod, true, "flat", 95D, "edinburgh", "12-00", "21-00", "10-00");
        propertyRepository.save(property1);

        Property property2 = new Property(stan, true, "room", 85D, "london", "12-00", "21-00", "10-00");
        propertyRepository.save(property2);

        Property property3 = new Property(john, true, "house", 230D, "glasgow", "12-00", "21-00", "10-00");
        propertyRepository.save(property3);

        Property property4 = new Property(john, true, "house", 120D, "glasgow", "12-00", "21-00", "10-00");
